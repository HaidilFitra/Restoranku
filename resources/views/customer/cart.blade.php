...
<div class="container-fluid py-5">
    <div class="container py-5">
        ...
        <div class="alert alert-info text-center">
            Keranjang Anda kosong. Silakan tambahkan item ke keranjang Anda.
        </div>
        @else
                    ...
                    <tr>
                        <th scope="row">
                            <div class="d-flex align-items-center">
                                <img src="{{ $item['img'] }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="" onerror="this.onerror=null;this.src='https://via.placeholder.com/80?text=No+Image';">
                            </div>
                        </th>
                        <td>
        ...
        <div class="d-flex justify-content-end">
            <a href="{{route('cart.clear')}}" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus semua item dari keranjang?')">Kosongkan Keranjang</a>
        </div>
