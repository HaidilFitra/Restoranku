                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ $item->img }}" class="img-fluid w-100 rounded-top" alt="" onerror="this.onerror=null;this.src='https://via.placeholder.com/400x300?text=No+Image';">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" 
                                            @if ($item->category->name == 'Makanan')
                                              bg-warning
                                            @elseif ($item->category->name == 'Minuman')
                                              bg-info
                                              @else
                                              bg-primary
                                            @endif
